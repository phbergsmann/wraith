...
TEMPLATE_LOCATION = "#{File.dirname(__FILE__)}/gallery/gallery_template.erb"
TEMPLATE_BY_DOMAIN_LOCATION = "#{File.dirname(__FILE__)}/gallery/gallery_template.erb"
BOOTSTRAP_LOCATION = "#{File.dirname(__FILE__)}/gallery/bootstrap.min.css"
